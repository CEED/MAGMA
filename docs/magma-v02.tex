...
\begin{verbatim}
void magma_ssymv (char uplo , int m , float alpha ,  float *A , int lda ,  float *X , int incx , float beta , float *Y , int incy )
...
\begin{verbatim}
void magma_dsymv (char uplo , int m , double alpha ,  double *A , int lda ,  double *X , int incx , double beta , double *Y , int incy )
...
Note: When matrix dimension is multiple of STRSM's internal block size 32, you will get
higher performance. 
\end{verbatim}
