 ...
 *
 *  MAGMA_zgetrf - Computes an LU factorization of a general M-by-N matrix A
 ...
 *
 *  MAGMA_zgetrf_Tile - Computes the tile LU factorization of a matrix.
 ...
 * @sa MAGMA_zgetrf
 * @sa MAGMA_zgetrf_Tile_Async
 * @sa MAGMA_cgetrf_Tile
 * @sa MAGMA_dgetrf_Tile
 * @sa MAGMA_sgetrf_Tile
 ...
 *
 *  MAGMA_zgetrf_Tile_Async - Computes the tile LU factorization of a matrix.
 *  Non-blocking equivalent of MAGMA_zgetrf_Tile().
 ...
 * @sa MAGMA_zgetrf
 * @sa MAGMA_zgetrf_Tile
 * @sa MAGMA_cgetrf_Tile_Async
 * @sa MAGMA_dgetrf_Tile_Async
 * @sa MAGMA_sgetrf_Tile_Async
 * @sa MAGMA_zgetrs_Tile_Async
 *
 ******************************************************************************/
int MAGMA_zgetrf_Tile_Async(magma_desc_t *A, magma_desc_t *L, int *IPIV,
