 ...
 *
 ******************************************************************************/
int MAGMA_zplgsy( PLASMA_Complex64_t bump, int N,
 ...
 *
 *  MAGMA_zplgsy_Tile - Generate a random hermitian matrix by tiles.
 *  Tile equivalent of MAGMA_zplgsy().
 ...
 * @sa MAGMA_zplgsy
 * @sa MAGMA_zplgsy_Tile_Async
 * @sa MAGMA_cplgsy_Tile
 * @sa MAGMA_dplgsy_Tile
 * @sa MAGMA_splgsy_Tile
 * @sa MAGMA_zplrnt_Tile
 * @sa MAGMA_zplgsy_Tile
 *
 ******************************************************************************/
int MAGMA_zplgsy_Tile( PLASMA_Complex64_t bump, magma_desc_t *A,
                         unsigned long long int seed )
{
    magma_context_t *magma;
    magma_sequence_t *sequence = NULL;
 ...
 *
 *  MAGMA_zplgsy_Tile_Async - Generate a random hermitian matrix by tiles.
 *  Non-blocking equivalent of MAGMA_zplgsy_Tile().
 ...
 * @sa MAGMA_zplgsy
 * @sa MAGMA_zplgsy_Tile
 * @sa MAGMA_cplgsy_Tile_Async
 * @sa MAGMA_dplgsy_Tile_Async
 * @sa MAGMA_splgsy_Tile_Async
 * @sa MAGMA_zplgsy_Tile_Async
 * @sa MAGMA_zplgsy_Tile_Async
 *
 ******************************************************************************/
