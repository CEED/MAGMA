...
extern "C" __global__ void sgemm_kernel_T_T_64_16_16_16_4_v2(float *C, const float *A, const float *B, int m,int n, int k, int lda, int ldb, int ldc, float alpha, float beta) {
...
extern "C" void
magmablas_sgemm_kernel_T_T_64_16_16_16_4_v2( float *C, const float *A, const float *B, int m,int n, int k, int lda, int ldb, int ldc, float alpha, float beta)
{
        dim3 threads( 16, 4 );
        dim3 grid(m/64,n/16);
        sgemm_kernel_T_T_64_16_16_16_4_v2<<< grid, threads >>> ( C, A, B, m, n, k, lda , ldb , ldc , alpha , beta ) ;
}
