...
extern "C" __global__ void sgemm_kernel_T_N_32_32_8_8_8(float *C, const float *A, const float *B, int m,int n, int k, int lda, int ldb, int ldc, float alpha, float beta) {
...
extern "C" void
magmablas_sgemm_kernel_T_N_32_32_8_8_8( float *C, const float *A, const float *B, int m,int n, int k, int lda, int ldb, int ldc, float alpha, float beta)
{	
        dim3 threads( 8, 8 );
        dim3 grid(m/32+(m%32!=0),n/32+(n%32!=0));
        sgemm_kernel_T_N_32_32_8_8_8<<< grid, threads >>> ( C, A, B, m, n, k, lda , ldb , ldc , alpha , beta ) ;
}
