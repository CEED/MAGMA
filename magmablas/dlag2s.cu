...
dlag2s_generic(const double *A, float *SA, int M, int N, int lda,
...
extern "C" __global__ void 
dlag2s_special(const double *A, float *SA, int M, int N, int lda,int LDSA, 
               double RMAX) 
{
	int ibx = blockIdx.x * 64;
	int tx = threadIdx.x;
...
extern "C" void 
magmablas_dlag2s_64_64_16_4_v2(int M, int N , const double *A, int lda, float *SA, 
                               int LDSA, float RMAX ) 
{    
	if( M==0 || N==0 ){
...
extern "C" void 
magmablas_dlag2s(int M, int N , const double *A, int lda, float *SA , 
             int LDSA, float RMAX ) 
{    
/*
  Note
