...
extern "C" __global__ void  sgemm_kernel_N_N_64_16_16_16_4
...
extern "C" void
magmablas_sgemm_kernel_N_N_64_16_16_16_4( float *C, const float *A, const float *B, int m,int n, int k, int lda, int ldb, int ldc, float alpha, float beta)
{
        dim3 threads( 16, 4 );
        dim3 grid(m/64+(m%64!=0),n/16+(n%16!=0));
        sgemm_kernel_N_N_64_16_16_16_4<<< grid, threads >>> ( C, A, B, m, n, k, lda , ldb , ldc , alpha , beta ) ;
}
