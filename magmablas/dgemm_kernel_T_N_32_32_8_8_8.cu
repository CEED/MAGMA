...
extern "C" __global__ void dgemm_kernel_T_N_32_32_8_8_8(double *C, const double *A, const double *B, int m,int n, int k, int lda, int ldb, int ldc, double alpha, double beta) {
...
extern "C" void
magmablas_dgemm_kernel_T_N_32_32_8_8_8( double *C, const double *A, const double *B, int m,int n, int k, int lda, int ldb, int ldc, double alpha, double beta)
{	
        dim3 threads( 8, 8 );
        dim3 grid(m/32+(m%32!=0),n/32+(n%32!=0));
        dgemm_kernel_T_N_32_32_8_8_8<<< grid, threads >>> ( C, A, B, m, n, k, lda , ldb , ldc , alpha , beta ) ;
}
