...
int main( int argc, char** argv) 
{
    ...
    int maxNB = magma_get_dpotrf_nb(size[9]);
    cudaMallocHost( (void**)&h_work,  maxNB*maxNB*sizeof(double) );
    ...
    //h_R = (double*)malloc(n2 * sizeof(h_R[0]));
	...
	h_R[j] = (h_A[j]+=2000);
      ...
      magma_dpotrf_gpu("U", &N, d_A, &lda, h_work, info);
      cublasSetVector(n2, sizeof(double), h_A, 1, d_A, 1);
	 ...
	 =================================================================== */
      ...
      magma_dpotrf_gpu("L", &N, d_A, &lda, h_work, info);
      //magma_dpotrf_gpu("U", &N, d_A, &lda, h_work, info);
	...
	printf("Argument %d of dpotrf had an illegal value.\n", -info[0]);     
      ...
      double work[1], matnorm, mone = -1.0;
      int one = 1;
