...
int main( int argc, char** argv)
{
    ...
    for( int i = 0; i < opts.ntest; ++i ) {
        for( int iter = 0; iter < opts.niter; ++iter ) {
            ...
            if (info != 0)
                printf("magma_zgeev returned error %d.\n", (int) info);
            ...
            if ( opts.check ) {
                ...
                magma_zgeev_m( MagmaVectors, MagmaVectors,
                               N, h_R, lda, w1,
                               VL, lda, VR, lda,
                               h_work, lwork, rwork, &info );
                ...
                lapackf77_zlacpy( MagmaUpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_zgeev_m( MagmaNoVectors, MagmaNoVectors,
                               N, h_R, lda, w2,
                               &DUM, 1, &DUM, 1,
                               h_work, lwork, rwork, &info );
                ...
                if (info != 0) {
                    result[0] = ulpinv;
                    printf("magma_zgeev (case N, N) returned error %d.\n", (int) info);
                }
                ...
                lapackf77_zlacpy( MagmaUpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_zgeev_m( MagmaNoVectors, MagmaVectors,
                               N, h_R, lda, w2,
                               &DUM, 1, LRE, lda,
                               h_work, lwork, rwork, &info );
                ...
                if (info != 0) {
                    result[0] = ulpinv;
                    printf("magma_zgeev (case N, V) returned error %d.\n", (int) info);
                }
                ...
                lapackf77_zlacpy( MagmaUpperLowerStr, &N, &N, h_A, &lda, h_R, &lda );
                magma_zgeev_m( MagmaVectors, MagmaNoVectors,
                               N, h_R, lda, w2,
                               LRE, lda, &DUM, 1,
                               h_work, lwork, rwork, &info );
                ...
                if (info != 0) {
                    result[0] = ulpinv;
                    printf("magma_zgeev (case V, N) returned error %d.\n", (int) info);
                }
