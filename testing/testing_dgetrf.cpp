...
int main( int argc, char** argv) 
{
    ...
    //status = cublasAlloc(n2+lwork+2*maxnb*maxnb,sizeof(double),(void**)&d_A);
	...
	h_R[j] = h_A[j] = rand() / (double)RAND_MAX;
      ...
      magma_dgetrf(&N, &N, h_R, &N, ipiv, h_work, d_A, info);
