...
magma_int_t magma_zgehrd( magma_int_t n, magma_int_t ilo, magma_int_t ihi,
			  ...
			  cuDoubleComplex *work, magma_int_t *lwork, cuDoubleComplex *da,
			  magma_int_t *info);
...
magma_int_t magma_zgeqlf( magma_int_t m, magma_int_t n, 
                          cuDoubleComplex *A,    magma_int_t lda,   cuDoubleComplex *tau, 
                          cuDoubleComplex *work, magma_int_t lwork, magma_int_t *info);
magma_int_t magma_zgeqrf2( magma_int_t m, magma_int_t n, cuDoubleComplex *A, 
...
magma_int_t magma_zgeqrf( magma_int_t m, magma_int_t n, cuDoubleComplex *A, 
			  magma_int_t lda, cuDoubleComplex *tau, cuDoubleComplex *work, 
			  magma_int_t lwork, magma_int_t *info);
magma_int_t magma_zgetrf_mc( magma_int_t *m, magma_int_t *n, cuDoubleComplex *A, 
...
magma_int_t magma_zlabrd( magma_int_t m, magma_int_t n, magma_int_t nb, 
			  cuDoubleComplex *a, magma_int_t lda, double *d,  
			  double  *e, cuDoubleComplex *tauq,   cuDoubleComplex *taup,  
			  cuDoubleComplex *x, magma_int_t ldx, cuDoubleComplex *y,  
			  magma_int_t ldy, cuDoubleComplex *da, magma_int_t ldda, 
...
magma_int_t magma_zgeqrf_gpu( magma_int_t m, magma_int_t n, cuDoubleComplex *A, 
			      magma_int_t lda, cuDoubleComplex *tau, cuDoubleComplex *dwork, 
			      magma_int_t *info);
magma_int_t magma_zgeqrf2_gpu(magma_int_t m, magma_int_t n, cuDoubleComplex *A, 
