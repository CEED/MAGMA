...
magma_int_t
magma_zgerbt_gpu(char gen, magma_int_t N,
    magma_int_t NRHS, magmaDoubleComplex *dA,
    magma_int_t lda, magmaDoubleComplex *dB,
    magma_int_t ldb, magmaDoubleComplex *U,
