...
magma_int_t magma_zgeqlf( magma_int_t m, magma_int_t n, double2 *A,
			  magma_int_t lda, double2 *tau, double2 *work, 
			  magma_int_t *lwork, magma_int_t *info);
...
magma_int_t magma_zlabrd( magma_int_t m, magma_int_t n, magma_int_t nb, 
			  double2 *a, magma_int_t lda, double2 *d,  
			  double2 *e, double2 *tauq, double2 *taup,  
...
magma_int_t magma_zlahru( magma_int_t m, magma_int_t n, magma_int_t nb, 
			  ...
			  double2 *dwork);
magma_int_t magma_zlarfb( char direct, char storev, magma_int_t m, 
			  magma_int_t n, magma_int_t k, double2 *dv, 
			  magma_int_t ldv, double2 *dt, magma_int_t ldt, 
			  double2 *dc, magma_int_t ldc, double2 *dowrk, 
			  magma_int_t ldwork);
