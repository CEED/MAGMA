...
void MORSE_zttmqr(MorseOption_t * options,
                       int side, int trans,
                       int m1, int n1, int m2, int n2, int k, int ib,
                       magma_desc_t *A1, int A1m, int A1n,
                       magma_desc_t *A2, int A2m, int A2n,
                       magma_desc_t *V, int Vm, int Vn, int ldv,
                       magma_desc_t *T, int Tm, int Tn)
{
    ...
    DAG_CORE_TTMQR;
    QUARK_Insert_Task(options->quark, CORE_zttmqr_quark, options->task_flags,
        ...
        sizeof(PLASMA_Complex64_t)*nb*nb,   BLKADDR(A2, PLASMA_Complex64_t, A2m, A2n),          INOUT,
        sizeof(int),                        &lda2,  VALUE,
        sizeof(PLASMA_Complex64_t)*nb*nb,   BLKADDR(V, PLASMA_Complex64_t, Vm, Vn),             INPUT|QUARK_REGION_D|QUARK_REGION_U,
