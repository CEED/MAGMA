...
void MORSE_zttmlq(MorseOption_t * options,
                       int side, int trans,
                       ...
                       magma_desc_t *T, int Tm, int Tn)
{
    ...
    DAG_CORE_TTMLQ;
    QUARK_Insert_Task(options->quark, CORE_zttmlq_quark, options->task_flags,
        ...
        sizeof(PLASMA_Complex64_t)*nb*nb,   BLKADDR(V, PLASMA_Complex64_t, Vm, Vn),             INPUT|QUARK_REGION_D|QUARK_REGION_L,
