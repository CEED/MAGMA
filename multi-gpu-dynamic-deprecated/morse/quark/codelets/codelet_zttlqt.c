...
#undef REAL
#define COMPLEX
void MORSE_zttlqt(MorseOption_t * options,
                  int m, int n, int ib,
                  ...
                  magma_desc_t *T, int Tm, int Tn)
{
    ...
    DAG_CORE_TTLQT;
    QUARK_Insert_Task(options->quark, CORE_zttlqt_quark, options->task_flags,
        sizeof(int),                        &m,     VALUE,
        sizeof(int),                        &n,     VALUE,
        sizeof(int),                        &ib,    VALUE,
        sizeof(PLASMA_Complex64_t)*nb*nb,   BLKADDR(A1, PLASMA_Complex64_t, A1m, A1n),          INOUT|QUARK_REGION_D|QUARK_REGION_L,
        sizeof(int),                        &lda1,  VALUE,
        sizeof(PLASMA_Complex64_t)*nb*nb,   BLKADDR(A2, PLASMA_Complex64_t, A2m, A2n),          INOUT|QUARK_REGION_D|QUARK_REGION_L,
