    ...
    magma_queue_t queue )
{
    ...
    int r4dg3 = 1;
    //printf(" grid: %d x %d x %d\n", r1dg1, r1dg2, r1dg3 );
    dim3 r4block( r4bs1, r4bs2, 1 );
    dim3 r4grid( r4dg1, r4dg2, r4dg3 );
    
    
    if( uplotype == MagmaLower ){//printf("in here lower new kernel\n");
        //cudaProfilerStart();
        magma_zlowerisai_a32_kernel3<<< r3grid, r3block, 0, queue->cuda_stream() >>>(                                                         
            L.num_rows,                                                                                   
            L.row,
            L.col,
            L.val,
        ...
        magma_zupperisai_a32_kernel3<<< r3grid, r3block, 0, queue->cuda_stream() >>>(                                                         
            L.num_rows,                                                                                   
            L.row,
            L.col,
            L.val,
