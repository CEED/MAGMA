...
/*  =====================================================================  */
__global__ void
magma_zpipelined_dznrm2_kernel( int m, magmaDoubleComplex *da, int ldda, magmaDoubleComplex *dxnorm )
{
...
__global__ void 
magma_zpipelined_scale( int n, magmaDoubleComplex *r, magmaDoubleComplex *drnorm ){
    int i = blockIdx.x * blockDim.x + threadIdx.x;
    if( i<n ){
...
magma_zcopyscale(   int n, 
    ...
    magma_zpipelined_correction<<<Gs, Bs, Ms, magma_stream>>>( n, k, skp, r, v );
    magma_zpipelined_copyscale<<<Gs2, Bs, 0, magma_stream>>>( n, k, skp, r, v );
...
magma_dznrm2scale( int m, magmaDoubleComplex *r, int lddr, magmaDoubleComplex *drnorm) {
    ...
    dim3  blocks( 1 );
    dim3 threads( 512 );
    magma_zpipelined_dznrm2_kernel<<< blocks, threads, 0, magma_stream >>>( m, r, lddr, drnorm );
