    ...
    magma_queue_t queue )
{
    ...
    // workspace
    magma_z_matrix r,rr,p,v,s,t,ms,mt,y,z;
    ...
    magma_zvinit( &ms,Magma_DEV, A.num_rows, b.num_cols, c_zero, queue );
    magma_zvinit( &mt,Magma_DEV, A.num_rows, b.num_cols, c_zero, queue );
