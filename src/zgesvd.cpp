...
/*  -- MAGMA (version 1.0) --
    ...
    static cuDoubleComplex c_b1 = {0.,0.};
    static cuDoubleComplex c_b2 = {1.,0.};
    ...
    char ch__1[2];
    /* Builtin functions   
       Subroutine */ int s_cat(char *, char **, magma_int_t *, magma_int_t *, ftnlen);
    double sqrt(double);
    /* Local variables */
    ...
    extern /* Subroutine */ int dlascl_(char *, magma_int_t *, magma_int_t *, 
	    double *, double *, magma_int_t *, magma_int_t *, double *, 
	    magma_int_t *, magma_int_t *), xerbla_(char *, magma_int_t *),
	     zgebrd_(magma_int_t *, magma_int_t *, cuDoubleComplex *, magma_int_t *, 
	    double *, double *, cuDoubleComplex *, cuDoubleComplex *, 
    ...
    extern double zlange_(char *, magma_int_t *, magma_int_t *, cuDoubleComplex *, 
	    magma_int_t *, double *);
    static double bignum;
    extern /* Subroutine */ int zgelqf_(magma_int_t *, magma_int_t *, cuDoubleComplex *, 	     magma_int_t *, cuDoubleComplex *, cuDoubleComplex *, magma_int_t *, magma_int_t * 	    ), zlascl_(char *, magma_int_t *, magma_int_t *, double *, double 
	    *, magma_int_t *, magma_int_t *, cuDoubleComplex *, magma_int_t *, magma_int_t *), zgeqrf_(magma_int_t *, magma_int_t *, cuDoubleComplex *, magma_int_t *,
	     cuDoubleComplex *, cuDoubleComplex *, magma_int_t *, magma_int_t *), zlacpy_(
	    char *, magma_int_t *, magma_int_t *, cuDoubleComplex *, magma_int_t *, 
	    cuDoubleComplex *, magma_int_t *), zlaset_(char *, magma_int_t *, 
	    magma_int_t *, cuDoubleComplex *, cuDoubleComplex *, cuDoubleComplex *, 
	    magma_int_t *);
    static magma_int_t ldwrkr;
    extern /* Subroutine */ int zbdsqr_(char *, magma_int_t *, magma_int_t *, magma_int_t 
	    *, magma_int_t *, double *, double *, cuDoubleComplex *, 
	    magma_int_t *, cuDoubleComplex *, magma_int_t *, cuDoubleComplex *, magma_int_t *,
	     double *, magma_int_t *);
    static magma_int_t minwrk, ldwrku, maxwrk;
    extern /* Subroutine */ int zungbr_(char *, magma_int_t *, magma_int_t *, magma_int_t 
	    *, cuDoubleComplex *, magma_int_t *, cuDoubleComplex *, cuDoubleComplex *, 
	    magma_int_t *, magma_int_t *);
    static double smlnum;
    static magma_int_t irwork;
    extern /* Subroutine */ int zunmbr_(char *, char *, char *, magma_int_t *, 
	    magma_int_t *, magma_int_t *, cuDoubleComplex *, magma_int_t *, cuDoubleComplex *, 	     cuDoubleComplex *, magma_int_t *, cuDoubleComplex *, magma_int_t *, magma_int_t * 	    ), zunglq_(magma_int_t *, magma_int_t *, magma_int_t *
	    , cuDoubleComplex *, magma_int_t *, cuDoubleComplex *, cuDoubleComplex *, 
	    magma_int_t *, magma_int_t *);
    static logical lquery, wntuas, wntvas;
    extern /* Subroutine */ int zungqr_(magma_int_t *, magma_int_t *, magma_int_t *, 
	    cuDoubleComplex *, magma_int_t *, cuDoubleComplex *, cuDoubleComplex *, 
	    magma_int_t *, magma_int_t  *);
