...
extern"C"{
    ...
    {
        lapackf77_zstedc(compz, n, D, E, Z, ldz, work, ldwork, rwork, lrwork, iwork, 
                         liwork, info);
    }  
}

extern"C"
void dmove_eig(char range, magma_int_t n, double *w, magma_int_t *il, 
...
#ifdef FAST_HEMV
    magma_zhetrd2_gpu(uplo, n, da, ldda, &w[1], &rwork[inde],
                      &work[indtau], wa, ldwa, &work[indwrk], llwork, dc, lddc*n, &iinfo);
#else
    magma_zhetrd_gpu (uplo, n, da, ldda, &w[1], &rwork[inde],
