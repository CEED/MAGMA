...
int 
magma_zgeqrf_gpu(int *m, int *n, double2 *a, int *lda,  double2 *tau,
...
/*  -- MAGMA (version 0.2) --
    ...
    ZGEQRF computes a QR factorization of a double complex M-by-N matrix A:   
    A = Q * R.   
    ...
    where tau is a double complex scalar, and v is a double complex vector with   
