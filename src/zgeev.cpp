...
magma_zgeev(char *jobvl, char *jobvr, magma_int_t *n, 
	    cuDoubleComplex *a, magma_int_t *lda, cuDoubleComplex *w, cuDoubleComplex *vl, 
	    magma_int_t *ldvl, cuDoubleComplex *vr, magma_int_t *ldvr, cuDoubleComplex *work, 
...
/*  -- MAGMA (version 1.0) --
    ...
    extern double zlange_(char *, magma_int_t *, magma_int_t *, cuDoubleComplex *, 
			      magma_int_t *, double *);
    extern int 
      zgehrd_(magma_int_t *, magma_int_t *, magma_int_t *, 
    ...
    extern int 
      zhseqr_(char *, char *, magma_int_t *, magma_int_t *, magma_int_t *,
	      cuDoubleComplex *, magma_int_t *, cuDoubleComplex *, cuDoubleComplex *,
	      magma_int_t *, cuDoubleComplex *, magma_int_t *, magma_int_t *),
      ztrevc_(char *, char *, logical *, magma_int_t *, cuDoubleComplex *, magma_int_t *,
