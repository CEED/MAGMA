...
void MAGMA_ZGEHRD( magma_int_t *n, magma_int_t *ilo, magma_int_t *ihi, double2 *A, magma_int_t *lda, double2 *tau, double2 *work, magma_int_t *lwork, devptr_t *da, magma_int_t *info)
{ 
    cuDoubleComplex *d_a = (cuDoubleComplex *)(*da);
    magma_zgehrd( *n, *ilo, *ihi, A, *lda, tau, work, lwork, d_a, info); 
}
...
void MAGMA_ZLARFB( char *direct, char *storev, magma_int_t *m, magma_int_t *n, magma_int_t *k, devptr_t *dv, magma_int_t *ldv, devptr_t *dt, magma_int_t *ldt, devptr_t *dc, magma_int_t *ldc, devptr_t *dwork, magma_int_t *ldwork)
{ 
    cuDoubleComplex *d_v = (cuDoubleComplex *)(*dv);
    cuDoubleComplex *d_t = (cuDoubleComplex *)(*dt);
    cuDoubleComplex *d_c = (cuDoubleComplex *)(*dc);
    cuDoubleComplex *d_w = (cuDoubleComplex *)(*dwork);
    magma_zlarfb( direct[0], storev[0], *m, *n, *k, d_v, *ldv, d_t, *ldt, d_c, *ldc, d_w, *ldwork); 
}
...
void MAGMA_ZSYTRD( char *uplo, magma_int_t *n, double2 *A, magma_int_t *lda, double2 *d, double2 *e, double2 *tau, double2 *work, magma_int_t *lwork, devptr_t *da, magma_int_t *info)
{ 
    cuDoubleComplex *d_a = (cuDoubleComplex *)(*da);
    magma_zsytrd( uplo[0], *n, A, *lda, d, e, tau, work, lwork, d_a, info); 
}
...
{ 
    ...
    cuDoubleComplex *d_c  = (cuDoubleComplex *)(*c);
    cuDoubleComplex *d_td = (cuDoubleComplex *)(*td);
    magma_zgeqrs_gpu( *m, *n, *nrhs, d_a, *lda, tau, d_c, *ldc, work, lwork, d_td, info); 
}
